...
return {
  ...
  highlights = function(c, config)
    ...
    local is_context_default = plugin_config.context_highlight == "default"
    local is_context_underline = plugin_config.context_start_underline

    local augroup = vim.api.nvim_create_augroup("ArethaDarkBufferline", { clear = true })
    ...
    return {
      ...
      IndentBlanklineContextChar  = is_context_default and { fg = c.base.blue } or { fg = c.editorIndentGuide.activeBackground },
      IndentBlanklineContextStart = { sp = is_context_default and c.base.blue or c.editorIndentGuide.activeBackground, underline = is_context_underline },
      ...
      IblScope                    = is_context_default and { fg = c.base.red } or { fg = c.editorIndentGuide.activeBackground },
    }
  end,
}
