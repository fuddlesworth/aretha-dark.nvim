...
return {
  ...
  highlights = function(scheme, config)
    ...
    return {
      ...
      Cursor = { bg = scheme.base.blue, fg = scheme.editor.background },
      ...
      -- Window separators
      VertSplit = { bg = scheme.editor.background, fg = scheme.base.dark },
      WinSeparator = { fg = scheme.base.dark },
      ...
      -- Matching
      MatchParen = { fg = scheme.base.blue, bold = true, underline = true },
      ...
      FloatBorder = float_win_clear and {
        ...
        bg = scheme.editor.background,
        fg = scheme.editorSuggestWidget.border,
      },
      ...
      -- Whitespace
      Whitespace = { fg = scheme.base.dimmed6 },
