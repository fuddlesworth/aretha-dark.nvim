...
---@field hex_to_rgb fun(hex: string): ArethaDark.RGB
---@field rgb_to_hex fun(rgb: ArethaDark.RGB): string
---@field apply_highlights fun(highlights: table<string, vim.api.keyset.highlight>)

local blend = require("aretha-dark.colors.blend")
local convert = require("aretha-dark.colors.convert")
